...
\begin{document}
	...
	\include{content/01_Einleitung}
        \include{content/02_Hintergrund}
        \include{content/03_Analyse}
        \include{content/04_Konzept}
        \include{content/05_Implementierung}
        \include{content/06_Evaluation}
        \include{content/07_Diskussion}
        \include{content/08_Zusammenfassung}
        %\include{content/99_Playground}
