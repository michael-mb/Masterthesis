...
Die Interviews wurden mit einer Gruppe von vier wissenschaftlichen Mitarbeitern von zwei Hochschulen geführt, nämlich
der Universität Duisburg-Essen und der Technischen Universität Dortmund (siehe~\ref{tab:personnen}).
...
der Klasse ``Buch'' korrekt verwendet hat (siehe~\ref{fig:combined}). Es gibt jedoch mehrere Möglichkeiten, wie diese
...
Kennung erstellt werden. Dies ermöglicht schließlich die Generierung von GReQL-Code (siehe~\ref{lst:combined}), der eine der
