...
\begin{figure}[h]
    \centering
    \includegraphics[width=13cm]{images/bau_gmbh_plantText}
...
\begin{enumerate}[itemsep=8pt, parsep=5pt]
    ...
    GReQL-Regeln zu ermög-lichen, um einen direkten Vergleich zu erleichtern. Er erwähnte auch, dass man auf dem
...
\begin{figure}[h]
    \centering
    \includegraphics[width=13cm]{images/features-2n3}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{images/combined}
